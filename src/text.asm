...
.xl
    ...
    ; not enabled - disable everything and return. TODO: only need to run this
    ; once. better solution would be to have the script hide_text_box opcode set
    ; a flag, which is checked here and set back to 0
